          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Starting as craftsmen in 1995, we have grown to become Kerala's only dedicated mirror manufacturing industry and one of its most trusted names. Our dedication to quality and innovation has earned us recognition, including the prestigious Best Entrepreneur Award from DIC, Govt. of Kerala
                </p>
                <p>
